...
// ? what do you expect each line to print?
console.log(undefined || null);//null or false
console.log(!``);//true
...
let age = 9;
age > 10 ?
console.log("full menu") : console.log("kids menu");
// Using only logical operators (no comparison operators),
// write an if statement that prints...
//  "The number is zero" when num is 0.

let num = 0;//zero can be equal to not something or it can be equal to something
if (!num) {
